...
x_values = np.array([300, 500, 700, 900])
kw = np.array([2.502, 2.641, 2.414, 2.384])
F_values = np.array([0.00018, 0.00024, 0.00032, 0.0004])

# Data for the error bars
errors = np.array([0.062, 0.066, 0.032, 0.011])
