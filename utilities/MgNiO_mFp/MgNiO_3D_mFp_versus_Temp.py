...
num_points = 280
x_values = np.array([100, 300, 500, 700, 900])  # 5 different Temp
y_values_per_x = [shc_nu[:num_points], shc_nu[:num_points], shc_nu[:num_points], shc_nu[:num_points], shc_nu[:num_points]]
z_values_per_x = [lambda_i_avg_100K[:num_points], lambda_i_avg_300K[:num_points], lambda_i_avg_500K[:num_points], lambda_i_avg_700K[:num_points], lambda_i_avg_900K[:num_points]]
