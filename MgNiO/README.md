...
|:----------------------:| :----------------------:|
 | Average of 10 runs with `F = 0.0001`            | Average of 10 runs with `F = 0.00014`            | 
...
|:----------------------:|:----------------------:|
| Average of 10 runs with `F = 0.0004`            | Average of 10 runs with `F = 0.0008`            | 
...
|:----------------------:|
| Average of 10 runs with `F = 0.00014`            | 


### Future Work: Use the desired F-values = 0.00014 to perform simulations at different temperatures (100 - 900K)
