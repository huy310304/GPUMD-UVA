...
l = [42.499480645074,  42.49800849231, 42.49712499833075]
Lx, Lz = l[0], l[2]
Ly = 4.249800849231
V = Lx * Ly * Lz

T = 500 # Change Temp to 100K here
Fe = 1.5e-4 # Change Force to 1.4e-4 here

calc_spectral_kappa(shc, driving_force=Fe, temperature=T, volume=V)
shc['kw'] = shc['kwi'] + shc['kwo']
shc['K'] = shc['Ki'] + shc['Ko']
Gc = np.load('../../../../ballistic/Expand_Box_Size/Gc_400.npy')
shc.keys()
...
## Save kappa stuff
np.save("shc_nu_5_400_file.npy", shc["nu"])
np.save("shc_kw_5_400_file.npy", shc["kw"])
